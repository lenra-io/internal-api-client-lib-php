...
/**
 * UpdateManyDocumentsRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpdateManyDocumentsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateManyDocuments_request';
    ...
    */
     ...
     * Sets filter
     *
     * @param array<string,mixed> $filter Mongo data query
     *
     * @return self
     */
     ...
     * Sets update
     *
     * @param array<string,mixed> $update Mongo data query
     *
     * @return self
     */
